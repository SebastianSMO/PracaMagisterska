...
class CategoryIdBetterPagBench extends AbstractBenchmark
{
    ...
    {
        return "Wszystkie produkty z kategorii o id " . self::CATEGORY_ID . " + zoptymalizowane stronicowanie (" . self::PER_PAGE . " na strone)";
    }
